...
# The distribution is extremely right-skewed; the vast majority of genes have either no expression or very minimal expression in the liver.I expect other tissues will display a similar pattern since the human genome includes information relevant to all cell types, but only certain cell types will strongly express certain genes. I produced another histogram with lung data and observed a similar distribution, supporting my hypothesis.
```
